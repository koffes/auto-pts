...
def test_cases(ptses):
    ...
    custom_test_cases = [
        ZTestCase('TMAP', 'TMAP/UMR/ASC/BV-04-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_cap, advData, True)] + [TestFunc(announcements_bap, advData, True)]+ adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
        ZTestCase('TMAP', 'TMAP/UMR/ASC/BV-05-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_cap, advData, True)] + [TestFunc(announcements_bap, advData, True)] + adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
        ZTestCase('TMAP', 'TMAP/UMR/ASC/BV-06-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_cap, advData, True)] + [TestFunc(announcements_bap, advData, True)] + adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
        ZTestCase('TMAP', 'TMAP/BMR/DDI/BV-01-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_tmap, advData, TMAPRole.BROADCAST_MEDIA_RECEIVER)] + adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
        ZTestCase('TMAP', 'TMAP/UMR/DDI/BV-01-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_tmap, advData, TMAPRole.UNICAST_MEDIA_RECEIVER)] + adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
        ZTestCase('TMAP', 'TMAP/BMS/DDI/BV-01-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_tmap, advData, TMAPRole.BROADCAST_MEDIA_SENDER)] + adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
        ZTestCase('TMAP', 'TMAP/BMS/CTXT/BV-01-C', cmds=pre_conditions + [TestFunc(adv_init, advData)] + [TestFunc(announcements_cap, advData, True)] + [TestFunc(announcements_bap, advData, True)] +[TestFunc(announcements_tmap, advData, TMAPRole.BROADCAST_MEDIA_SENDER, Context.MEDIA)] + adv_end,
                  generic_wid_hdl=tmap_wid_hdl),
    ]
